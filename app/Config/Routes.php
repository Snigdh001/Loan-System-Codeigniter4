...
$routes->match(['post','get'],'/signup','Home::signup');
$routes->match(['post','get'],'login','Home::login');
$routes->match(['post','get'],'/userdashboard','Home::userdashboard');
$routes->match(['post','get'],'admindashboard','Admin::admindashboard');
$routes->get('admindashboard/update','Admin::update');
