...
<head>
    ...
    <link rel="stylesheet" href="static/css/loan_registration.css">
                                        ...
                                        <div class="p-5">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-4 pb-2 mb-md-0 pb-md-0">
                                                    <div class="mb-4 pb-2">
                                                        <div class="form-outline">
                                                            <label class="form-label" for="form3Examplev5">Mobile
                                                                Number</label>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-4 pb-2 mb-md-0 pb-md-0">
                                                    <div class="mb-4 pb-2">
                                                        <div class="form-outline">
                                                            <label class="form-label" for="form3Examplev5">Aadhar
                                                                Number</label>
                                                            <input type="text" id="form3Examplev5"
                                                                class="form-control form-control-lg" />
                                                        </div>
                                                ...
                                                <div class="col-md-6 mb-4 pb-2 mb-md-0 pb-md-0">
                                                    <div class="mb-4 pb-2">
                                                        <div class="form-outline">
                                                            <label class="form-label" for="form3Examplev5">Pan
                                                                Number</label>
                                                            <input type="text" id="form3Examplev5"
                                                                class="form-control form-control-lg" />
                                                        </div>
                                            ...
                                            <h3 class="fw-normal mb-5" style="color: #4835d4;">Loan Details</h3>

                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-4 pb-2">
                                                        <label class="form-label" for="form3Examplev5">Profession</label>
                                                        <select class="select form-control form-control-lg">
                                                ...
                                                <div class="col-md-6 mb-4 pb-2 mb-md-0 pb-md-0">
                                                    <div class="mb-4 pb-2">
                                                        <div class="form-outline">
                                                            <label class="form-label" for="form3Examplev5">Annual Income</label>
                                                            <input type="text" id="form3Examplev5"
                                                                class="form-control form-control-lg" />
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-4 pb-2 mb-md-0 pb-md-0">
                                                    <div class="mb-4 pb-2">
                                                        <div class="form-outline">
                                                            <label class="form-label" for="form3Examplev5">Loan Amount</label>
                                                            <input type="text" id="form3Examplev5"
                                                                class="form-control form-control-lg" />
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-6 mb-4 pb-2 mb-md-0 pb-md-0">
                                                    <div class="mb-4 pb-2">
                                                        <div class="form-outline">
                                                            <label class="form-label" for="form3Examplev5">Duration (In month)</label>
                                                            <input type="text" id="form3Examplev5"
                                                                class="form-control form-control-lg" />
                                                        </div>
                                                    </div>
